...
export default function GarageLayout({ children, title }: Props) {
    ...
    return (
        <div className="flex min-h-screen bg-gray-50">
            ...
            <aside
                className={cn(
                    'md:hidden fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 flex flex-col transition-transform duration-200',
            ...
            <main className="flex-1 flex flex-col min-w-0">
                <header
                    className={cn(
                        'h-14 bg-white border-b border-gray-200 items-center px-4 md:px-6 gap-3',
